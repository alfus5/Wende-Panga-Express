...
//const firebaseConfig = {apiKey: "AIzaSyBo4JVuZi5AtC1wY1TXx4Az8ckQv5QrBPI",authDomain: "wende-panga-express.firebaseapp.com",projectId: "wende-panga-express",storageBucket: "wende-panga-express.firebasestorage.app",messagingSenderId: "661266039149",appId: "1:661266039149:web:a6b82733096ed5217a9a64",measurementId: "G-0JKLWTYV81"};

// Initialiser Firebase
//const app = initializeApp(firebaseConfig); const analytics = getAnalytics(app); const database = getDatabase(app); // Initialiser la base de données


// Écrire des données
//database.ref('rendezvous/').push({client: "John Doe",tel: "06 00 00 00 00",date: "05-06-2025",heure: "17:30",service: 0,message: `🔧 Service : Vanne EGRDescription : La vanne EGR réduit les émissions de NOx en recyclant les gaz.❗ Symptômes :- Ralenti instable- Odeur de gaz- Moteur bruyant`});
